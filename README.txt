...
Contributors: Peter J Harrison
Donate link: http://www.peterjharrison.me
Tags: category, categories, chain select, drop down, ajax
...
= 3.0 =
Please upgrade to new version of pugin by deleting the old version first. This plugin is not backwards compatible so you will need to update the template tag as well.